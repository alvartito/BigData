package org.utad.analisisLogs.ejemplos.hadoop.writables;
 ...
 * of the hottest day for each location per each year using custom
 * writables. Input file to use:
...
//			String dayStr = row[2];
			...
			outKey.setLocation(locationStr);
			outKey.setYear(Integer.valueOf(yearStr));
