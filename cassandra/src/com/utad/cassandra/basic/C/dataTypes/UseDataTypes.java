...
public class UseDataTypes {
	 ...
	 * Caso 1
	 * <p>
	 * crear el column family usando tipo Bytes en la ordenaci髇 de las column
	 * keys
	 * 
	...
	private static void caso1() throws ConnectionException {
		...
		try {
			ksUsers.createColumnFamily(cfUsers, ImmutableMap
					...
					// c贸mo almacenar谩 cassandra internamente las column keys
					.put("key_validation_class", "BytesType")
					// c贸mo se ordenar谩n las column keys
