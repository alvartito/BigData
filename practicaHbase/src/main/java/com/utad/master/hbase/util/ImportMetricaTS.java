package com.utad.master.hbase.util;
 ...
 */
	 ...
	 */
    private ImportMetricaTS() throws IOException {
	...
	private void execute() throws Exception {
		...
		job.setJarByClass(ImportMetricaTS.class);
...
//		job.setOutputFormatClass(TextOutputFormat.class);
	...
	public static void main(String[] args) throws Exception {
		...
		ImportMetricaTS modelo=new ImportMetricaTS();
